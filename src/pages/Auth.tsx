...
const Auth = () => {
  ...
  useEffect(() => {
    if (!authLoading && authUser) {
      // Sync Google avatar if applicable (non-blocking)
      const googleAvatar =
      ...
      if (googleAvatar) {
        supabase
          ...
          .eq("id", authUser.id)
          .then(({ error }) => {
            if (error) console.warn("Avatar sync failed:", error);
          });
      }
  ...
  const handleForgotPassword = async () => {
    if (!email) {
      toast({
        ...
        description: "We need your email to send a sign-in link.",
      });
      return;
    }
    setLoading(true);
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-card/50 backdrop-blur-xl border border-border/50 rounded-2xl p-6 sm:p-8 shadow-2xl">
          ...
          <Button
            type="button"
            variant="outline"
            className="w-full h-11 mb-4 gap-3 border-border/60 hover:bg-muted/50 font-medium"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    inputMode="text"
                    className="pl-10 h-11 bg-background/50 border-border/50 focus:border-primary transition-colors text-base md:text-sm"
                  />
                </div>
              </div>
            )}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 pr-10 h-11 bg-background/50 border-border/50 focus:border-primary transition-colors text-base md:text-sm"
                />
                <button
                  type="button"
